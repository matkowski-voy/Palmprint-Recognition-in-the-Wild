function [net,stats] = cnn_train_dagEE_PRnet(net, imdb, getBatch, varargin)
...
toc
  ...
  if(strcmp(opts.strategy,'S0'))
  end
  if(strcmp(opts.strategy,'S1'))
  end
  if(strcmp(opts.strategy,'S2'))
  end
  if(strcmp(opts.strategy,'S3'))
      if(epoch == opts.ft_align_epoch)
        net.params(20).learningRate = opts.lr_factor;
        net.params(19).learningRate = opts.lr_factor;
        net.params(18).learningRate = opts.lr_factor;
        net.params(17).learningRate = opts.lr_factor;
        net.params(16).learningRate = opts.lr_factor;
        net.params(15).learningRate = opts.lr_factor;
      end
  end
  if(strcmp(opts.strategy,'S4'))
      if(epoch == opts.ft_align_epoch)
        net.params(20).learningRate = opts.lr_factor;
        net.params(19).learningRate = opts.lr_factor;
        net.params(18).learningRate = opts.lr_factor;
